# Desktop Quickstep Compat Library

The `compatLib` library helps integrate Desktop with QuickSwitch while ensuring backward-compatibility with older Android versions.
