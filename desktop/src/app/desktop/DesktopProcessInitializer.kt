...
import app.desktop.bugreport.DesktopBugReporter
...
@Keep
class DesktopProcessInitializer(context: Context) : QuickstepProcessInitializer(context) {

    override fun init(context: Context) {
        DesktopBugReporter.INSTANCE.get(context)
