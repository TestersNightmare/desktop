...
import app.desktop.search.adapter.SPACE_MINI
import app.desktop.search.adapter.SearchTargetCompat
import app.desktop.search.model.SearchResultActionCallBack
        ...
        if (target.packageName == HEADER_JUSTIFY) {
            clearHistory.setOnClickListener {
                val suggestionsRecent = SearchRecentSuggestions(
                    launcher,
                    DesktopRecentSuggestionProvider.AUTHORITY,
                    DesktopRecentSuggestionProvider.MODE,
                )
