...
import app.desktop.DesktopProto.BackupInfo
import app.desktop.util.hasFlag
import app.desktop.util.scaleDownTo
import app.desktop.util.scaleDownToDisplaySize
...
class DesktopBackup(
    ...
    companion object {
        ...
        fun generateBackupFileName(): String {
            val fileName = "Desktop_Backup ${SimpleDateFormat.getDateTimeInstance().format(Date())}"
            return "$fileName.desktopbackup"
        }
        ...
        suspend fun create(context: Context, contents: Int, screenshotBitmap: Bitmap, fileUri: Uri) {
            ...
            val info = BackupInfo.newBuilder()
                .setDesktopVersion(BuildConfig.VERSION_CODE)
