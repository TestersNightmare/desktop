...
import app.desktop.views.LauncherPreviewView
...
class CreateBackupViewModel(
    ...
    val backupContents = savedStateHandle.getStateFlow(
        "contents",
        DesktopBackup.INCLUDE_LAYOUT_AND_SETTINGS or DesktopBackup.INCLUDE_WALLPAPER,
    )
    ...
    private suspend fun captureScreenshot(): Bitmap? {
        return suspendCancellableCoroutine { continuation ->
            ...
            val themedContext = ContextThemeWrapper(context, R.style.Theme_Desktop)
