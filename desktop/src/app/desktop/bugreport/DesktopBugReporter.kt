...
class DesktopBugReporter(private val context: Context) {
    ...
    inner class Report(val error: String, val throwable: Throwable? = null) {
        ...
        private fun writeContents() = StringBuilder()
            ...
            .appendLine("isRecentsEnabled: ${DesktopApp.isRecentsEnabled}")
            .appendLine()
    ...
    companion object {
        val INSTANCE = MainThreadInitializedObject(::DesktopBugReporter)
    }
}
