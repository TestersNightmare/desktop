...
class DesktopWidgetHolder(context: Context, intConsumer: IntConsumer?) : LauncherWidgetHolder(context, intConsumer) {

    @Keep
    class DesktopHolderFactory
    @Suppress("unused")
    constructor(
        ...
        fun newInstance(
            ...
            return if (!FeatureFlags.ENABLE_WIDGET_HOST_IN_BACKGROUND.get()) {
                ...
                DesktopWidgetHolder(context, appWidgetRemovedCallback)
            }
        }
    }
}
