...
package app.desktop.preferences
...
class PreferenceManager private constructor(private val context: Context) :
    ...
    private val recreate = {
        DesktopLauncher.instance?.recreateIfNotScheduled()
        Unit
    }
    ...
    val workspaceRows = IntPref("pref_workspaceRows", 6)
    ...
    val drawerOpacity = FloatPref("pref_drawerOpacity", 0.0F, recreate)
    ...
    val isShowSplashSta = BoolPref("pref_isShowSplashSta", false)
    val isFirstLoad = BoolPref("pref_isFirstLoad", true)
