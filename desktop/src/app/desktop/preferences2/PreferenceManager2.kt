...
package app.desktop.preferences2
...
import app.desktop.data.Converters
...
import app.desktop.icons.CustomAdaptiveIconDrawable
import app.desktop.icons.shape.IconShape
import app.desktop.icons.shape.IconShapeManager
import app.desktop.preferences.PreferenceManager as DesktopPreferenceManager
import app.desktop.qsb.providers.QsbSearchProvider
import app.desktop.search.algorithms.DesktopSearchAlgorithm
import app.desktop.search.algorithms.data.WebSearchProvider
import app.desktop.smartspace.model.SmartspaceCalendar
import app.desktop.smartspace.model.SmartspaceMode
import app.desktop.smartspace.model.SmartspaceTimeFormat
import app.desktop.theme.color.ColorMode
import app.desktop.theme.color.ColorOption
import app.desktop.theme.color.ColorStyle
import app.desktop.ui.popup.LauncherOptionsPopup
import app.desktop.ui.preferences.components.HiddenAppsInSearch
import app.desktop.ui.preferences.data.liveinfo.LiveInformationManager
import app.desktop.util.kotlinxJson
import app.desktop.views.overlay.FullScreenOverlayMode
...
class PreferenceManager2 private constructor(private val context: Context) :
    ...
    val searchAlgorithm = preference(
        ...
        defaultValue = DesktopSearchAlgorithm.LOCAL_SEARCH,
        onSet = { reloadHelper.recreate() },
    )
    ...
    val enableFontSelection = preference(
        ...
        onSet = { newValue ->
            if (!newValue) {
                ...
                DesktopPreferenceManager.getInstance(context).fontWorkspace.set(newValue = fontCache.uiText)
            }
        },
    )
...
//        defaultSelector = { numAllAppsColumns },
    ...
    val deckLayout = preference(
        ...
        defaultValue = context.resources.getBoolean(R.bool.config_enable_lawn_deck),
