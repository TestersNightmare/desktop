package app.desktop.search.adapter
...
import app.desktop.allapps.views.SearchResultView
import app.desktop.search.algorithms.data.Calculation
import app.desktop.search.algorithms.data.ContactInfo
import app.desktop.search.algorithms.data.FileInfo
import app.desktop.search.algorithms.data.FileInfo.Companion.isImageType
import app.desktop.search.algorithms.data.FolderInfo
...
import app.desktop.util.createTextBitmap
import app.desktop.util.file2Uri
import app.desktop.util.mimeCompat
