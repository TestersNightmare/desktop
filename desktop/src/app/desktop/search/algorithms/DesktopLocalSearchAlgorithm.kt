package app.desktop.search.algorithms

import android.content.Context
import android.os.Handler
import app.desktop.preferences.PreferenceManager
import app.desktop.preferences2.PreferenceManager2
import app.desktop.search.adapter.CALCULATOR
import app.desktop.search.adapter.CONTACT
import app.desktop.search.adapter.ERROR
import app.desktop.search.adapter.FILES
import app.desktop.search.adapter.HEADER_JUSTIFY
import app.desktop.search.adapter.HISTORY
import app.desktop.search.adapter.LOADING
import app.desktop.search.adapter.SETTINGS
import app.desktop.search.adapter.SPACE
import app.desktop.search.adapter.SearchTargetCompat
import app.desktop.search.adapter.SearchTargetFactory
import app.desktop.search.adapter.WEB_SUGGESTION
import app.desktop.search.algorithms.data.Calculation
import app.desktop.search.algorithms.data.ContactInfo
import app.desktop.search.algorithms.data.IFileInfo
import app.desktop.search.algorithms.data.RecentKeyword
import app.desktop.search.algorithms.data.SettingInfo
import app.desktop.search.algorithms.data.WebSearchProvider
import app.desktop.search.algorithms.data.calculateEquationFromString
import app.desktop.search.algorithms.data.findContactsByName
import app.desktop.search.algorithms.data.findSettingsByNameAndAction
import app.desktop.search.algorithms.data.getRecentKeyword
import app.desktop.search.algorithms.data.queryFilesInMediaStore
import app.desktop.search.model.SearchResult
import app.desktop.util.checkAndRequestFilesPermission
import app.desktop.util.isDefaultLauncher
import app.desktop.util.requestContactPermissionGranted
...
class DesktopLocalSearchAlgorithm(context: Context) : DesktopSearchAlgorithm(context) {
    ...
    private suspend fun performDeviceLocalSearch(
        ...
        if (prefs.searchResulRecentSuggestion.get()) {
            getRecentKeyword(
                ...
                object : app.desktop.search.algorithms.data.SearchCallback {
