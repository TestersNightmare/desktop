...
import app.desktop.theme.color.AndroidColor
import app.desktop.theme.color.ColorOption
import app.desktop.theme.color.ColorStyle
import app.desktop.theme.color.MonetColorSchemeCompat
import app.desktop.theme.color.SystemColorScheme
import app.desktop.ui.theme.getSystemAccent
import app.desktop.wallpaper.WallpaperManagerCompat
...
class ThemeProvider(private val context: Context) : SafeCloseable {
    ...
    val colorScheme get() = when (val accentColor = this.accentColor) {
        ...
        is ColorOption.WallpaperPrimary -> {
            ...
            getColorScheme(wallpaperPrimary ?: ColorOption.DesktopBlue.color, colorStyle.style)
        }
        is ColorOption.CustomColor -> getColorScheme(accentColor.color, colorStyle.style)
        else -> getColorScheme(ColorOption.DesktopBlue.color, colorStyle.style)
    }
