...
import app.desktop.override.CustomizeAppDialog
...
class DesktopShortcut {
    ...
    companion object {
        ...
        val CUSTOMIZE =
            SystemShortcut.Factory { activity: DesktopLauncher, itemInfo, originalView ->
        ...
        private fun getAppInfo(launcher: DesktopLauncher, itemInfo: ItemInfo): ModelAppInfo? {
        ...
        val PAUSE_APPS = SystemShortcut.Factory { activity: DesktopLauncher, itemInfo: ItemInfo, originalView: View ->
    ...
    class Customize(
        ...
        itemInfo: ItemInfo,
        originalView: View,
    ) : SystemShortcut<DesktopLauncher>(R.drawable.ic_edit, R.string.action_customize, launcher, itemInfo, originalView) {
    ...
    class PauseApps(
        target: DesktopLauncher,
        itemInfo: ItemInfo,
        originalView: View,
    ) : SystemShortcut<DesktopLauncher>(
            ...
            AlertDialog.Builder(context)
                ...
                .setPositiveButton(R.string.pause) { _, _ ->
                    try {
                        ...
                        Log.e("DesktopShortcut", "Failed to pause app", e)
                    }
                }
                .show()
