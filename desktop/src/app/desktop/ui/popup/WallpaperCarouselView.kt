...
import app.desktop.data.wallpaper.model.WallpaperViewModel
import app.desktop.views.component.IconFrame
...
class WallpaperCarouselView @JvmOverloads constructor(
    ...
    private val deviceProfile = ActivityContext.lookupContext<DesktopLauncher>(context).deviceProfile
