...
package app.desktop.ui.preferences
...
import app.desktop.ui.preferences.about.acknowledgements.OssLibrary
import app.desktop.ui.preferences.destinations.IconPackInfo
import app.desktop.util.Constants.LAWNICONS_PACKAGE_NAME
import app.desktop.util.getPackageVersionCode
...
class PreferenceViewModel(private val app: Application) :
    ...
    override val iconPacks = flow {
        ...
        val desktopIcon = CustomAdaptiveIconDrawable.wrapNonNull(
