...
import app.desktop.data.iconoverride.IconOverrideRepository
...
import app.desktop.ui.preferences.components.FeedPreference
import app.desktop.ui.preferences.components.GestureHandlerPreference
import app.desktop.ui.preferences.components.HomeLayoutSettings
import app.desktop.ui.preferences.components.NavigationActionPreference
import app.desktop.ui.preferences.components.OverlayHandlerPreference
...
import app.desktop.util.collectAsStateBlocking
...
fun HomeScreenPreferences(
    ...
    PreferenceLayout(
        ...
        PreferenceGroup(heading = stringResource(id = R.string.status_bar_label)) {
            ...
            ExpandAndShrink(visible = showStatusBarAdapter.state.value && DesktopApp.isRecentsEnabled) {
                SwitchPreference(
