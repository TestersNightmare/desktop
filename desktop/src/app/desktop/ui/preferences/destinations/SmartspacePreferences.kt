...
import app.desktop.smartspace.SmartspaceViewContainer
import app.desktop.smartspace.model.DesktopSmartspace
...
import app.desktop.smartspace.model.Smartspacer
import app.desktop.smartspace.provider.SmartspaceProvider
...
import app.desktop.ui.theme.isSelectedThemeDark
...
fun SmartspacePreferences(
    ...
    val modeIsDesktop = selectedMode == DesktopSmartspace
    ...
    PreferenceLayout(
        ...
        if (fromWidget) {
            DesktopSmartspaceSettings(smartspaceProvider)
        } else {
            MainSwitchPreference(
                adapter = smartspaceAdapter,
                label = stringResource(R.string.smartspace_widget_toggle_label),
                description = stringResource(id = R.string.smartspace_widget_toggle_description).takeIf { modeIsDesktop },
            ) {
                PreferenceGroup {
...
@Composable
private fun DesktopSmartspaceSettings(
