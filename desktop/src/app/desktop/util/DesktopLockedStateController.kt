...
object DesktopLockedStateController {

    private const val TAG = "DesktopLockedStateController"
    ...
    private val backgroundThread: HandlerThread by lazy {
        HandlerThread("Recents-DesktopLockedStateController", 10)
    }
    ...
    fun initialize(context: Context): DesktopLockedStateController {
