...
val fileProviderAuthority: String = "${DesktopApp.instance.packageName}.fileprovider"

fun String.path2Uri(): Uri? = File(this).file2Uri()

fun File.file2Uri(): Uri? = try {
    FileProvider.getUriForFile(DesktopApp.instance, fileProviderAuthority, this)
} catch (e: Exception) {
    e.printStackTrace()
    null
}
