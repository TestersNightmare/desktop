package app.desktop.util

import DesktopLockedStateController
...
object TaskUtilLockState {
    ...
    fun setTaskLockState(context: Context, componentName: ComponentName, isState: Boolean, taskKey: Task.TaskKey) {
        DesktopLockedStateController.initialize(context).setTaskLockState(componentName.toShortString(), isState, taskKey.userId)
    ...
    private fun updateSpecifiedTaskLockState(context: Context, componentName: ComponentName, taskKey: Task.TaskKey): Boolean {
        val taskLockState = DesktopLockedStateController.initialize(context)
