...
class DesktopFloatingSurfaceView @JvmOverloads constructor(
    context: Context?,
    ...
    private val mLauncher: DesktopLauncher = context!!.launcher
    ...
    private fun getBackgroundAnimator(): ObjectAnimator {
        ...
        val targetDepth = mLauncher.stateManager.state.getDepth<DesktopLauncher?>(mLauncher)
    ...
    companion object {
         ...
         */
        fun show(launcher: DesktopLauncher, contract: GestureNavContract?) {
            val view: DesktopFloatingSurfaceView =
                launcher.viewCache.getView<DesktopFloatingSurfaceView?>(
