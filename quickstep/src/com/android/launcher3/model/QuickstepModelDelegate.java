...
public class QuickstepModelDelegate extends ModelDelegate {
    ...
    public void modelLoadComplete() {
        ...
        // time.
        if (mIsPrimaryInstance && DesktopApp.isRecentsEnabled()) {
    ...
    protected void registerSnapshotLoggingCallback() {
        if (mStatsManager == null || !DesktopQuickstepCompat.ATLEAST_R) {
    ...
    public void destroy() {
        ...
        if (mIsPrimaryInstance && mStatsManager != null && DesktopQuickstepCompat.ATLEAST_R) {
            try {
