...
public class QuickstepLauncher extends Launcher implements RecentsViewContainer {
    ...
    protected void setupViews() {
        ...
        if (enableDesktopWindowingMode() && DesktopApp.isRecentsEnabled()) {
            mDesktopRecentsTransitionController = new DesktopRecentsTransitionController(
                    getStateManager(), systemUiProxy, DesktopApp.getInstance().getIApplicationThread(),
                    getDepthController());
        }
        ...
        mEnableWidgetDepth = DesktopApp.isRecentsEnabled() ? SystemProperties.getBoolean("ro.launcher.depth.widget", true) : false;
...
//                getApplicationInfo().isOnBackInvokedCallbackEnabled();
    ...
    public void onUiChangedWhileSleeping() {
        ...
        UI_HELPER_EXECUTOR.execute(
                () -> DesktopQuickstepCompat.getActivityManagerCompat().invalidateHomeTaskSnapshot(this));
    }
