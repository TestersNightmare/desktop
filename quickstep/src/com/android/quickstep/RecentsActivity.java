...
public final class RecentsActivity extends StatefulActivity<RecentsState> implements
    ...
    public ActivityOptionsWrapper getActivityLaunchOptions(final View v, @Nullable ItemInfo item) {
        ...
        final ActivityOptions options = DesktopQuickstepCompat.getActivityOptionsCompat().makeRemoteAnimation(
                new RemoteAnimationAdapter(wrapper, RECENTS_LAUNCH_DURATION,
                        RECENTS_LAUNCH_DURATION - STATUS_BAR_TRANSITION_DURATION
                                - STATUS_BAR_TRANSITION_PRE_DELAY),
                DesktopQuickstepCompat.getRemoteTransitionCompat().getRemoteTransition(wrapper.toRemoteTransition(),
    ...
    private void startHomeInternal() {
        ...
        ActivityOptions options = DesktopQuickstepCompat.getActivityOptionsCompat().makeRemoteAnimation(
                new RemoteAnimationAdapter(runner, HOME_APPEAR_DURATION, 0),
                DesktopQuickstepCompat.getRemoteTransitionCompat().getRemoteTransition(runner.toRemoteTransition(),
                        this.getIApplicationThread(),
