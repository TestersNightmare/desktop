...
public class RecentsAnimationDeviceState implements DisplayInfoChangeListener, ExclusionListener {
    ...
    RecentsAnimationDeviceState(
        ...
        mIsOneHandedModeSupported = DesktopApp.isRecentsEnabled() && SystemProperties.getBoolean(SUPPORT_ONE_HANDED_MODE, false);
        ...
        if (mIsOneHandedModeSupported) {
            ...
            mIsOneHandedModeEnabled = DesktopApp.isRecentsEnabled() && settingsCache.getValue(oneHandedUri);
        ...
        mIsSwipeToNotificationEnabled = DesktopApp.isRecentsEnabled()
        ...
        mIsUserSetupComplete = DesktopApp.isRecentsEnabled() && settingsCache.getValue(setupCompleteUri, 0);
        ...
        try {
            mPipIsActive = DesktopApp.isRecentsEnabled() && Utilities.ATLEAST_S
