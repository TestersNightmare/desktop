...
import app.desktop.DeviceProfileOverrides;
...
public class InvariantDeviceProfile implements SafeCloseable {
        ...
        private void initGrid(Context context, Info displayInfo, DisplayOption displayOption,
                ...
                // Desktop ignores partner overrides and allows the user to customize the grid themselves
        ...
        public static List<GridOption> parseAllDefinedGridOptions(Context context) {
                ...
                Log.d("GridOption", "Total GridOptions: " + result.size());
			for (GridOption option : result) {
			    Log.d("GridOption", "GridOption: " + option.name + ", Rows: " + option.numRows + ", Columns: " + option.numColumns);
			}
