...
import static app.desktop.util.DesktopUtilsKt.toBitmap;
...
import app.desktop.DesktopAppKt;
import app.desktop.preferences.PreferenceManager;
import app.desktop.preferences2.PreferenceManager2;
import app.desktop.smartspace.DoubleShadowTextView;
import app.desktop.smartspace.SmartspaceAppWidgetProvider;
...
public class Workspace<T extends View & PageIndicator> extends PagedView<T>
    ...
    public void onDragStart(DragObject dragObject, DragOptions options) {
        ...
        if (mDragInfo != null && mDragInfo.cell != null) {
            CellLayout layout = (CellLayout) (mDragInfo.cell instanceof LauncherAppWidgetHostView
                    // https://github.com/DesktopLauncher/desktop/issues/3143
    ...
    public void updateStatusbarClock() {
        if (mCurrentPage == 0 && PreferenceExtensionsKt.firstBlocking(mPreferenceManager2.getStatusBarClock())) {
            DesktopAppKt.getDesktopApp(mLauncher).hideClockInStatusBar();
        } else {
            DesktopAppKt.getDesktopApp(mLauncher).restoreClockInStatusBar();
        }
    }
    ...
    public void bindAndInitFirstWorkspaceScreen() {
        ...
        if (mFirstPagePinnedItem == null) {
            ...
            if (!smartspaceMode.isAvailable(this.mLauncher)) {
                ...
                smartspaceMode = DesktopSmartspace.INSTANCE;
