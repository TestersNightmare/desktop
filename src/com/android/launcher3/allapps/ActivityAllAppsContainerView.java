...
import app.desktop.allapps.DesktopAlphabeticalAppsList;
...
import app.desktop.ui.StretchRecyclerViewContainer;
...
public class ActivityAllAppsContainerView<T extends Context & ActivityContext>
    ...
    protected void initContent() {
        ...
        mAH.set(AdapterHolder.MAIN, new AdapterHolder(AdapterHolder.MAIN,
                new DesktopAlphabeticalAppsList<>(mActivityContext, mAllAppsStore, null, mPrivateProfileManager)));
        mAH.set(AdapterHolder.WORK, new AdapterHolder(AdapterHolder.WORK,
                new DesktopAlphabeticalAppsList<>(mActivityContext, mAllAppsStore, mWorkManager, null)));
        mAH.set(SEARCH, new AdapterHolder(SEARCH,
                new DesktopAlphabeticalAppsList<>(mActivityContext, mAllAppsStore, null, null)));
