...
import com.android.launcher3.compat.ArchivedCompat;
...
import app.desktop.icons.DesktopIconProvider;
...
public class IconCache extends BaseIconCache {
    ...
    public IconCache(Context context, InvariantDeviceProfile idp) {
        this(context, idp, LauncherFiles.APP_ICONS_DB, new DesktopIconProvider(context));
    }
    ...
    public synchronized void updateTitleAndIcon(AppInfo application) {
        ...
        boolean preferPackageIcon = Flags.enableSupportForArchiving()
        && ArchivedCompat.isArchived(mLauncherApps.resolveActivity(
               application.getIntent(), application.user));
    ...
    public synchronized void getTitleAndIcon(ItemInfoWithIcon info,
        ...
        final boolean isAppArchived =
            Flags.enableSupportForArchiving() && ArchivedCompat.isArchived(activityInfo);
        // try {
