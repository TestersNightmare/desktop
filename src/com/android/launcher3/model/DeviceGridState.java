...
import app.desktop.DesktopProto;
...
public class DeviceGridState implements Comparable<DeviceGridState> {
    ...
    public DeviceGridState(DesktopProto.GridState protoGridState) {
    ...
    public DesktopProto.GridState toProtoMessage() {
        return DesktopProto.GridState.newBuilder()
