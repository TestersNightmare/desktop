...
public class LoaderTask implements Runnable {
    ...
    public static Set<String> getHiddenPackagesFromAssets(Context context) {
        Set<String> set = new HashSet<>();
        try (InputStream is = context.getAssets().open("hmd.txt");
    ...
    private List<LauncherActivityInfo> loadAllApps() {
        ...
        var enableBulkLoading = pref.getAllAppBulkIconLoading().get();
	      ...
	      Set<String> hiddenPackages = getHiddenPackagesFromAssets(mApp.getContext());
			...
			if (hiddenPackages.contains(packageName)) {
                ...
                try {
                    if (Flags.enableSupportForArchiving()) {
                        ...
                        if (ArchivedCompat.isArchived(app.getApplicationInfo())) {    
