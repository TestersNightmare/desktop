                        ...
                        if (isNewApkAvailable) {
                            ...
                            try {
                                if (Flags.enableSupportForArchiving() && !activities.isEmpty()) {
                                    //boolean newArchivalState = activities.get(0).getActivityInfo().isArchived;
                                    boolean newArchivalState = ArchivedCompat.isArchived(activities.get(0));
                                    //if (newArchivalState != si.isArchived()) {
                                    if (newArchivalState != (Flags.enableSupportForArchiving() && si != null && si.isArchived())) {   
