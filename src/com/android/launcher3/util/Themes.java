...
import static app.desktop.wallpaper.WallpaperColorsCompat.HINT_SUPPORTS_DARK_TEXT;
import static app.desktop.wallpaper.WallpaperColorsCompat.HINT_SUPPORTS_DARK_THEME;
...
import app.desktop.wallpaper.WallpaperColorsCompat;
import app.desktop.wallpaper.WallpaperManagerCompat;
import app.desktop.ui.theme.ColorKt;
...
public class Themes {
    ...
    public static float getDialogCornerRadius(Context context) {
        return context.getResources().getDimension(R.dimen.desktop_dialog_corner_radius);
    }
